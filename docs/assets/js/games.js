...
const games = [
  ...
  // ── 2月 ──────────────────────────────────────────────────
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://www.monsterhunter.com/wilds/ja-jp/",
    highlight:      true,
    purchaseLinks:  {
  ...
  },
  {
    ...
    link:           "https://store-jp.nintendo.com/list/software/D70010000092842.html",
    highlight:      true,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://www.playstation.com/ja-jp/games/death-stranding-2-on-the-beach/",
    highlight:      true,
    purchaseLinks:  {
  ...
  // ── 7月 ──────────────────────────────────────────────────
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://store-jp.nintendo.com/list/software/D70010000096306.html",
    highlight:      true,
    purchaseLinks:  {
  ...
  // ── 10月 ─────────────────────────────────────────────────
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://www.playstation.com/ja-jp/games/ghost-of-yotei/",
    highlight:      true,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "RPG",
    note:           null,
    link:           "https://www.pokemon.co.jp/ex/legends_z-a/ja/",
    highlight:      true,
    purchaseLinks:  {
  ...
  // ── 3月 ──────────────────────────────────────────────────
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://www.nintendo.com/jp/games/switch2/aqmxa/index.html",
    highlight:      true,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "競馬シミュレーション",
    note:           null,
    link:           "https://www.gamecity.ne.jp/winningpost10/2026/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "RPG",
    note:           null,
    link:           "https://store.steampowered.com/app/3515480?l=japanese",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://nippon1.jp/consumer/curse_warrior/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "アドベンチャー",
    note:           null,
    link:           "https://www.entergram.co.jp/sss/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "アドベンチャー",
    note:           null,
    link:           "https://loca.games/volontes/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "乙女ゲーム",
    note:           null,
    link:           "https://www.otomate.jp/dialover/lfge/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "RPG",
    note:           null,
    link:           "https://www.kemco.jp/game/rpg_selection_13/ja/",
    highlight:      false,
    purchaseLinks:  {
  ...
  },
  {
    ...
    genre:          "対戦",
    note:           "ダウンロード専売",
    link:           "https://www.pokemon.co.jp/ex/pokemon_champions/ja/",
    highlight:      true,
    sourceUrl:      "https://www.famitsu.com/schedule",
    sourceName:     "ファミ通",
    lastVerifiedAt: "2026-04-04",
  ...
  },
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://store.ubisoft.com/us/the-rogue-prince-of-persia?lang=en_US",
    highlight:      false,
    purchaseLinks:  {
      SW1: "https://www.amazon.co.jp/dp/B0G8HYS2SS",
      PS5: "https://www.amazon.co.jp/dp/B0G8HSK7HV",
    },
    sourceUrl:      "https://www.famitsu.com/schedule",
    sourceName:     "ファミ通",
    lastVerifiedAt: "2026-04-04",
  ...
  },
  {
    ...
    genre:          "アドベンチャー",
    note:           null,
    link:           "https://memoriesoff.jp/sousou/fd/",
    highlight:      false,
    purchaseLinks:  {
      PS5: "https://www.amazon.co.jp/dp/B0G6JXP87C",
    },
    sourceUrl:      "https://www.famitsu.com/schedule",
    sourceName:     "ファミ通",
    lastVerifiedAt: "2026-04-04",
  ...
  },
  {
    ...
    genre:          "シミュレーション",
    note:           null,
    link:           "https://www.nintendo.com/jp/switch/blfga/index.html",
    highlight:      true,
    purchaseLinks:  {
  ...
  },
  {
    ...
    highlight:      true,
    purchaseLinks:  {
      PS5:        "https://www.amazon.co.jp/dp/B0G6K7HJ1Q",
      SW2:        "https://www.amazon.co.jp/dp/B0G6KVPG3F",
      SW2_deluxe: "https://www.amazon.co.jp/dp/B0G6L511WT",
    },
    sourceUrl:      "https://www.famitsu.com/schedule",
    sourceName:     "ファミ通",
    lastVerifiedAt: "2026-04-04",
  ...
  // ── 5月 ──────────────────────────────────────────────────
  {
    ...
    link:             "https://www.bethesda.net/ja/game/indianajones",
    highlight:        false,
  ...
  },
  {
    ...
    genre:          "アクション",
    note:           null,
    link:           "https://www.nintendo.com/jp/games/switch2/aakga/index.html",
    highlight:      true,
    purchaseLinks:  {
  ...
  // ── 7月 ──────────────────────────────────────────────────
  {
    ...
    genre:          "ボードゲーム",
    note:           null,
    link:           "https://www.culdcept.com/series/culdcept_begins/",
    highlight:      false,
    purchaseLinks:  {
...

  {
    ...
    genre:          "ストラテジー",
    note:           "2026年発売予定",
    link:           "https://www.nintendo.com/jp/topics/article/1fa40820-586f-451c-8ac2-76b69d7a00ef",
    highlight:      true,
    sourceUrl:      null,
    sourceName:     "任天堂公式",
    lastVerifiedAt: null,
  },
  {
    ...
    link:           "https://www.fromsoftware.jp/duskbloods/",
    highlight:      true,
    sourceUrl:      null,
    sourceName:     "任天堂公式",
    lastVerifiedAt: null,
  ...
  },
  {
    ...
    link:           "https://store-jp.nintendo.com/list/software/D70010000096943.html",
    highlight:      false,
    sourceUrl:      null,
    sourceName:     "旧data.js",
    lastVerifiedAt: null,
