...
```json
{
  "id": "game-unique-id",
  "title": "ゲームタイトル",
  "date": "2026-04-16",       ← 日程未定は null にする
  "platforms": ["SW2"],       ← SW1/SW2/PS5/PS4/XBX/PC/MULTI
  "genre": "アクション",
  "note": "補足テキスト",      ← 不要なら null
  "link": "https://...",      ← Amazon等のURL。なければ null
  "highlight": true           ← 注目タイトルは true
}
```
